...
consumer_key = "zVbBgGOX1XWqmUFXAPN5A3xrb"  # Add your API key here
consumer_secret = "YNLBrvGSNXZs4H8Thpjz3isCS6UqAH3u2gyG7zHpBzYhiJLYiW"  # Add your API secret key here
...
# auth = OAuth1(consumer_key, consumer_secret, bearer_token, ACCESS_TOKEN_SECRET)
